...
figure;imagesc(-sign(real(seis_recordVz(1:4000,45:end-45))).*sqrt(real(seis_recordVz(1:4000,45:end-45)).^2+ imag(seis_recordVz(1:4000,45:end-45)).^2 ), [-0.0002 0.0002]);
colormap gray
xlabel('x/dx')
ylabel('Travel time(ms)')
