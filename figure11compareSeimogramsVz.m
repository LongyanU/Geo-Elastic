...
figure;plot(seis_recordVz(1:4000,400))
tt=seis_recordVz;

load('StaggeredGridFD2.mat')
hold  on;plot(seis_recordVz(1:4000,400),'k')
tt2=seis_recordVz;


load('KSpaceLayer2.mat')
hold on;plot(sign(real(seis_recordVz(1:4000,400))) .*sqrt(real(seis_recordVz(1:4000,400)).^2+ imag(seis_recordVz(1:4000,400)).^2)   ,'r')
